...
import CSRFToken from '../../redux/actions/CSRFToken';
...
const Signup = ({
    ...
    const validateField = (fieldName, value) => {
        ...
        switch (fieldName) {
            case 'first_name':
                if (!value.trim()) {
                    fieldErrors.first_name = 'Este campo es obligatorio';
                } else if (!/^[a-zA-Z]+$/.test(value)){
                    fieldErrors.first_name = 'El nombre no puede contener numeros ni caracteres especiales';
                }
                else {
            ...
            case 'last_name':
                if (!value.trim()) {
                    fieldErrors.last_name = 'Este campo es obligatorio';
                } else if(!/^[a-zA-Z]+$/.test(value)){
                    fieldErrors.last_name = 'El apellido no puede contener numeros ni caracteres especiales';
                }
                else {
            ...
            case 'email':
                ...
                if (!value.trim()) {
                    ...
                    fieldErrors.email = 'El correo no es valido';
                } else {
            ...
            case 'password':
                if (value.length < 8) {
                    fieldErrors.password = 'La contraseña debe contener minimo 6 caracteres';
                } else if (value === first_name) {
                    fieldErrors.password = 'La contraseña no puede ser igual al primer nombre'
                } if (/^\d+$/.test(password)) {
                    fieldErrors.password = "La contraseña no puede ser completamente numérica";
                }
                else {
            ...
            case 're_password':
                if (value !== password) {
                    fieldErrors.re_password = 'Las contraseñas no coinciden';
                } else {
                    delete fieldErrors.re_password;
                }
                break;
            default:
                break;
            ...
            <div className="flex-1 flex items-center justify-center h-screen">
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    ...
                    <div className="grid grid-cols-3 gap-x-3">
                        <button type="button" className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                    ...
                    <form onSubmit={e=>onSubmit(e)} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className={`w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg ${errors.first_name ? 'border-red-500' : ''}`}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className={`w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg ${errors.last_name ? 'border-red-500' : ''}`}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="password"
                                required
                                className={`w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg ${errors.re_password ? 'border-red-500' : ''}`}
                            />
                        ...
                        <button
                            ...
                            className={`w-full px-4 py-2 text-white font-medium ${
                                Object.keys(errors).length > 0 ? 'bg-gray-400' : 'bg-indigo-600 hover:bg-indigo-500'
